...
(function kMangaDownloader() {
  ...
  function createUI() {
    ...
    track.style.cssText = "all:initial;display:block;height:6px;overflow:hidden;border-radius:3px;background:#7c2d12;margin-top:6px;";
    ...
    const attachUI = () => {
      if (DOC.body && !DOC.getElementById("kmanga-dl-panel")) {
